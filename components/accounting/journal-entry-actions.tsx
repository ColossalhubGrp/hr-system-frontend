...
/**
 * Submit / cancel controls on the JE detail page. Draft (docstatus=0)
 * shows Submit; Submitted (docstatus=1) shows Cancel; Cancelled
 * (docstatus=2) shows nothing.
 */
export function JournalEntryActions({
  ...
  const onClick = () => {
    ...
    startTransition(async () => {
      const action = isDraft ? submitJournalEntryAction : cancelJournalEntryAction;
