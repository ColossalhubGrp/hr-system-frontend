            ...
            <AnimatePresence mode="popLayout">
              {!isAvatar && (
                ...
                <MotionContainer
                  ...
                  className={cn(
                    'bg-background aspect-square h-[120px] rounded-md border border-transparent transition-[border,drop-shadow]',
              ...
              {((cameraTrack && isCameraEnabled) || (screenShareTrack && isScreenShareEnabled)) && (
                ...
                >
                  <VideoTrack
                    ...
                    className="bg-muted aspect-square w-[120px] rounded-md object-cover"
                  />
                </MotionContainer>
              )}
            </AnimatePresence>
