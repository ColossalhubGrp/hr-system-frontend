...
/**
 * Submit / cancel controls on the Payment Entry detail page. Mirrors
 * the shape of JournalEntryActions.
 */
export function PaymentEntryActions({
  ...
  const onClick = () => {
    ...
    startTransition(async () => {
      const action = isDraft ? submitPaymentEntryAction : cancelPaymentEntryAction;
