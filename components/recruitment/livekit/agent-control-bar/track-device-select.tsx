...
import {
  ...
  SelectTrigger,
  SelectValue,
} from '@/components/recruitment/livekit/select';
import { cn } from '@/lib/cn';

type DeviceSelectProps = Omit<React.ComponentProps<typeof SelectTrigger>, 'size'> & {
...
export function TrackDeviceSelect({
  ...
  return (
    ...
    >
      <SelectTrigger className={cn(selectVariants({ size }), className)} {...props}>
        {size !== 'sm' && (
