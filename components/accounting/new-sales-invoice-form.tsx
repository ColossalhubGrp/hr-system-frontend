...
type Customer = { name: string; label: string };
...
export function NewSalesInvoiceForm({
  ...
  return (
    <form action={dispatch} className="flex flex-col gap-5">
      ...
      <FormSection title="Invoice" description="Which customer, on what dates, in which company.">
        <div className="grid gap-4 sm:grid-cols-2">
          <Field label="Customer" htmlFor="customer" error={fe.customer} required>
            <SelectInput
              id="customer"
              name="customer"
              defaultValue=""
      ...
      <FormSection title="Items" description="What is being billed. Rate auto-fills from item master; edit as needed.">
