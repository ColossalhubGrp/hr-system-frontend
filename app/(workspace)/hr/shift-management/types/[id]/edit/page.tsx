    ...
    <div className="flex flex-col gap-5">
      ...
      <ShiftTypeForm
        ...
        initial={{
          ...
          beginCheckInBeforeShiftStartTime: shift.beginCheckInBeforeShiftStartTime,
          lateEntryGracePeriod: shift.lateEntryGracePeriod,
          earlyExitGracePeriod: shift.earlyExitGracePeriod,
          processAttendanceAfter: shift.processAttendanceAfter,
          determineCheckInAndCheckOut: shift.determineCheckInAndCheckOut,
          workingHoursCalculationBasedOn: shift.workingHoursCalculationBasedOn,
          markAutoAttendanceOnHolidays: shift.markAutoAttendanceOnHolidays,
          enableLateEntryMarking: shift.enableLateEntryMarking,
          enableEarlyExitMarking: shift.enableEarlyExitMarking,
