...
export const NAV: NavItem[] = [
...

  {
    ...
    children: [
      ...
      { label: "Employee Advances", href: "/hr/employee-advances", requires: "HR_ANY" },
      { label: "Travel", href: "/hr/travel", requires: "HR_ANY" },
      { label: "Overtime Slips", href: "/hr/overtime-slips", requires: "HR_ANY" },
      { label: "Training", href: "/hr/training", requires: "HR_ANY" },
      { label: "Skill Assessments", href: "/hr/skill-assessments", requires: "HR_ANY" },
      { label: "Performance", href: "/hr/performance", requires: "HR_ANY" },
      { label: "Appraisal Overview", href: "/hr/performance/overview", requires: "HR_ANY" },
      { label: "Calibration (9-box)", href: "/hr/performance/calibration", requires: "HR_ANY" },
      { label: "Exit Interviews", href: "/hr/exit-interviews", requires: "HR_ANY" },
      { label: "Full and Final", href: "/hr/full-and-final", requires: "HR_ANY" },
    ],
  },
  ...
  // guard. Landing surface is the AI chat — Overview was removed.
  {
