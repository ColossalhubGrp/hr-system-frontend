...
const SECTIONS: Section[] = [
  {
    ...
    tiles: [
      { label: "Chart of Accounts", href: "/accounting/chart-of-accounts", icon: Layers, status: "pending" },
      ...
      { label: "Accounts Receivable", href: "/accounting/reports/accounts-receivable", icon: FileOutput, status: "pending" },
      { label: "General Ledger", href: "/accounting/reports/general-ledger", icon: BookText, status: "pending" },
      { label: "Trial Balance", href: "/accounting/reports/trial-balance", icon: Ratio, status: "pending" },
  ...
  },
  {
    ...
    tiles: [
      { label: "Chart of Cost Centers", href: "/accounting/cost-centers", icon: Building2, status: "pending" },
  ...
  },
  {
    ...
    tiles: [
      { label: "General Ledger", href: "/accounting/reports/general-ledger", icon: BookText, status: "pending" },
      { label: "Trial Balance", href: "/accounting/reports/trial-balance", icon: Ratio, status: "pending" },
      { label: "Profit and Loss", href: "/accounting/reports/profit-and-loss", icon: LineChart, status: "pending" },
      { label: "Balance Sheet", href: "/accounting/reports/balance-sheet", icon: Layers, status: "pending" },
      { label: "Cash Flow", href: "/accounting/reports/cash-flow", icon: ArrowLeftRight, status: "pending" },
      { label: "Accounts Receivable", href: "/accounting/reports/accounts-receivable", icon: FileOutput, status: "pending" },
      { label: "Accounts Payable", href: "/accounting/reports/accounts-payable", icon: FileInput, status: "pending" },
    ],
  },
];
